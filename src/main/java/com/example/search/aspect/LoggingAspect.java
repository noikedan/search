package com.example.search.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(String com.example.search.controllers.TaskController.index(..))")
    public void startLog(JoinPoint jp) {
        log.info("{}: Before処理", jp.getSignature());
    }

    @After("execution(* com.example.search.controllers.TaskController.*(..))")
    public void endLog(JoinPoint jp) {
        log.info("{}: After処理", jp.getSignature());
    }

    @Around("execution(* com.example.search..*(..))")
